        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '64px' }}>
          ...
          >
            <img
              ...
              style={{ width: '100%', height: '460px', objectFit: 'cover', borderRadius: '16px', display: 'block' }}
            />
          </motion.div>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '48px', marginTop: '32px', justifyContent: 'center' }}>
              <div style={{ textAlign: 'center' }}>
                <div style={{ color: '#f5a623', fontWeight: 800, fontSize: '40px' }}>18+</div>
                <div style={{ color: '#2d2d2d', fontSize: '16px', fontWeight: 500 }}>Customers</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ color: '#f5a623', fontWeight: 800, fontSize: '40px' }}>32+</div>
