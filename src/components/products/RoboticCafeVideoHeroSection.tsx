...
export default function RoboticCafeVideoHeroSection() {
  return (
    <section
    ...
    >
      ...
      >
        <source
          src="https://res.cloudinary.com/drqisyk9h/video/upload/q_auto/f_auto/v1779636899/robotic-cafe-page_thcoby.mp4"
          type="video/mp4"
        />
      </video>
      ...
      >
        ...
        >
          <span style={{ color: '#ffffff', fontWeight: 400 }}>
            CafeXbot Robotic Cafe proudly stands as the{' '}
          </span>
          <span style={{ color: '#f5a623', fontWeight: 700 }}>
            world&apos;s only fully automated multiproduct robot cafe
          </span>
          <span style={{ color: '#ffffff', fontWeight: 400 }}>
            {' '}offering a diverse range of food and drinks.
          </span>
        </p>
      </motion.div>
    </section>
