...
export default function HowCafeXbotMakesCoffeeSection() {
    ...
    <section className="bg-black py-16 px-6 text-center">
      ...
      >
        <h2 className="text-white font-bold text-4xl md:text-5xl mb-6">
          How CafeXbot Barista Robot Makes A Cup Of Coffee
        </h2>

        <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto leading-relaxed mb-10">
          Our barista robot boasts an impressive brewing time of just 70 to 90 seconds to deliver a
          cup of impeccably prepared, freshly ground coffee. As a result, customers receive a
          consistent and satisfying experience. Utilizing the state-of-the-art Franke Foam Master
          Coffee machine, this innovative system ensures consistent quality and precision with each
          cup. Moreover, let&apos;s not overlook the delightful touch of perfectly frothed foam that
          adorns every latte or cappuccino.
        </p>
