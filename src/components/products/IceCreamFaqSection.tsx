...
const faqItems = [
  ...
  {
    question: 'Q2: Details About Ice Cream System',
    answer: '',
  },
]
...
const characteristicsItems = [
  {
    question: 'Ice Cream Robot Provides Great Return on Investment!',
    answer:
      "Let's be frank. As an investor, you're purchasing CafeXbot Ice Cream Robot because you love the technology and see it as a profitable business. Its unique set of products and features ensure excellent returns, especially when placed in the right location. These benefits make CafeXbot a standout choice among robotic cafes. Many of them are listed in points below.\n\nAnd hey, on contrary to any other company producing robotic cafes, we can prove that CafeXbot makes money by showing you life cases and their numbers as they continue serving even while you are reading this article.",
  },
  {
    question: 'Can I include more product options than just ice cream?',
    answer: '',
  },
  {
    question: 'Passive Income Opportunity with CafeXbot Ice Cream Robot',
    answer: '',
  },
  {
  ...
  {
    question: 'Control CafeXbot Ice Cream Robot With Your Mobile Device',
    answer: '',
  },
  {
...
export default function IceCreamFaqSection() {
