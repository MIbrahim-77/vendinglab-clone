...
export default function IceCreamRobotHeroSection() {
  ...
  return (
    <section style={{ backgroundColor: '#eeeceb' }} className="py-12 px-4 md:py-16 md:px-8 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
        ...
        >
          <Image
            ...
            width={420}
            height={420}
            className="object-contain w-full max-w-[240px] md:max-w-[280px] lg:max-w-[420px] h-auto"
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-gray-900 font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight mb-4 md:mb-6 text-center">
            Your Own Ice Cream Robot Cafe Business
          </h2>

          <p className="text-sm md:text-base lg:text-lg leading-relaxed text-center max-w-sm mx-auto mb-6 md:mb-10">
