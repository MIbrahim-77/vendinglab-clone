  ...
  return (
    <section className="bg-slate-200 py-16 px-8 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        >
          <h2 className="text-gray-900 font-bold text-2xl sm:text-3xl lg:text-5xl leading-tight mb-6">
            Contact Us And Put This Barista Robot To Work For You!
          </h2>

          <p className="text-gray-600 text-base leading-relaxed max-w-sm mb-8 mx-auto lg:mx-0">
          ...
          <Link
            href={`/${locale}/contact`}
            className="inline-block bg-transparent border-2 border-yellow-600 text-gray-900 font-bold uppercase tracking-widest text-sm rounded-full px-10 py-3 hover:bg-yellow-50 transition w-full lg:w-auto"
          >
            CONTACT US
          </Link>
        </motion.div>
        ...
        >
          <div
            className="w-56 h-56 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full flex items-center justify-center overflow-hidden relative"
            style={{
